...
if (empty($emailsToSend)) {
  ...
  header('Location: /admin_upcoming_events_form.php?success=' . urlencode('All upcoming events emails were already sent.'));
  exit;
}
...
header_html('Sending Upcoming Events Emails');
?>
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
  <h2 style="margin: 0;">Sending Upcoming Events Emails</h2>
</div>
...
<div class="card">
  ...
  <div id="completionSummary" style="display: none; background-color: #f8f9fa; padding: 16px; border-radius: 6px; margin-top: 16px;">
    ...
    <div style="margin-top: 16px;">
      <a href="/admin_upcoming_events_form.php" class="button" style="margin-right: 10px;">← Send More Emails</a>
...
function showCompletionSummary() {
  ...
  if (summaryDiv && statsDiv) {
    ...
    if (suppressedCount > 0) {
      statsHtml += `<p><strong>Suppressed (already sent):</strong> ${suppressedCount}</p>`;
    }
